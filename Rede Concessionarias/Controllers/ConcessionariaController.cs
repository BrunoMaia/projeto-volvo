...
namespace RedeConcessionarias.Controllers;
{
    ...
    {
         static private List<Cliente> clientes;
        ...
        public void DeleteCliente(int IdCliente)
        {
            using(var _context = new RedeConcessionariaContext())
            {
                var entity = _context.Students.Find(IdCliente);
                if(entity == null)
                {
                    return ;
                }
    ...
    {
        static private List<Veiculo> veiculos;
        ...
        public void DeleteVeiculo(int IdVeiculo)
        {
            using(var _context = new RedeConcessionariaContext())
            {
                var entity = _context.Students.Find(IdVeiculo);
                if(entity == null)
                {
                    return ;
                }
    ...
    {
         static private List<Vendedor> vendedores;
        ...
        public IActionResult getVendedorByCPF(string CpfVendedor)
        {
            using(var _context = new RedeConcessionariaContext())
            {
                ...
                var vendedor = _context.Vendedor.FirstOrDefault(v=>v.CpfVendedor == CpfVendedor);
                if(vendedor == null)
                {
                    return NotFound("Vendedor não encontrado");
                }
        ...
        [HttpPost]
         public Veiculo PostVendedor([FromBody] Vendedor vendedor) //Cadastra o vendedor no banco de dados
         {
             using (var _context = new RedeConcessionariaContext())
             {
        ...
        public void DeleteVendedor(int IdVendedor)
        {
            using(var _context = new RedeConcessionariaContext())
            {
                ...
                if(entity == null)
                {
                    ...
                    _context.Clientes.Remove(entity);
                    _context.SaveChanges();
                    System.Console.WriteLine("Veiculo Removido.");
            }
        }
    }
    ...
    {
         static private List<Venda> vendas;
        ...
        public void DeleteVenda(int IdVendas)
        {
            using(var _context = new RedeConcessionariaContext())
            {
                var entity = _context.Vendedores.Find(IdVendas);
                if(entity == null)
                {
                    return ;
                }

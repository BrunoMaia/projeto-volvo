...
{
    public partial class RedeConcessionariaContext : DbContext
    {
        public RedeConcessionariaContext()
        {
        }

        public RedeConcessionariaContext(DbContextOptions<RedeConcessionariaContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server =.\\; Database = RedeConcessionaria; Trusted_Connection = True;");
            }
        }

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CadastroCliente = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    EnderecoClienteCidade = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EnderecoClienteBairro = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EnderecoClienteLogradouro = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EnderecoClienteNumero = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdVeiculo = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ChassiVeiculo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModeloVeiculo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AnoVeiculo = table.Column<int>(type: "int", nullable: false),
                    CorVeiculo = table.Column<string>(type: "nvarchar(max)", nullable: false),
